...
export const musicPlayerInit = () => {
  ...
  // FIXME: НЕ КОРРЕКТО РАБОТАЕТ АУДИОНАВИГАТОР (проблема была в том что не было проверки target.classList.contains("audio-button__play") перед тем  как нажимать на кнопку воспроизвести, а так же синтаксическая ошибка contain(s) и class(L)ist с маленькой было
